...
Google Drive is the active workspace. Before creating application output, read its private `data/about.md` master file. Keep all job-specific inputs and generated material in `jobs/[company]/`; use `job.txt` as the only job-description input.
