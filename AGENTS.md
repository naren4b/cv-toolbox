...
When working from that private workspace, read `AboutMe.md` and `Job-Applications/[company]/job.txt` from the private workspace root. Follow `toolbox/Architecture.md`, create private package outputs in the company folder, and maintain `Job-tracker.csv`.
