...
4. Create only missing `thinking.md`, `cv.md`, `prep.md`, and `email.md` or `cover-letter.md`. `thinking.md` must include an AI recommendation, readiness percentage, evidenced matches, material gaps, and next action.
