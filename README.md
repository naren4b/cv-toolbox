...
flowchart LR
    ...
    M --> S[Update status.md and Master Tracker]
```

| System | Responsibility |
| --- | --- |
| Google Drive `data/` | Canonical profile and personal information |
| Google Drive `jobs/[company]/` | Lead, posting, package, review, and follow-up |
| Google Drive `Job Search 2026 — Master Tracker` | Live application dashboard |
| GitHub repository | Versioned generic toolbox only |

## Standard application flow

1. Capture a lead and original source.
2. Create `jobs/[company]/` in Drive and add `job.txt`.
...
6. After confirmation, update `status.md` and the Master Tracker.
